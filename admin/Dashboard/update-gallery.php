...
if(empty($_FILES['slider'] ['name'])) {
 ...
 if(empty($_FILES['slider-2'] ['name'])) {
  ...
  if(empty($errors) == true) {
          move_uploaded_file($file_tmp,"../assets/img/Gallery/".$file_name2);
  }else{
   print_r($error);
   die();
  }
...
if(empty($_FILES['slider-3'] ['name'])) {
  ...
  if(empty($errors) == true) {
          move_uploaded_file($file_tmp,"../assets/img/Gallery/".$file_name3);
  }else{
   print_r($error);
   die();
  }
...
$sql = "UPDATE gellery_section SET heading = '{$heading}', paragraph = '{$paragraph}', slider_1 = '{$file_name}', slider_2 = '{$file_name2}', slider_3 = '{$file_name3}'";
